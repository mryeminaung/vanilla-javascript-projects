...
window.addEventListener('DOMContentLoaded', () => {
  ...
  filterBtns.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      let menuItems = menu.filter(menuItem => {
...
function displayBtns() {
  // let menuBtns = [...new Set(menu.map((item) => {
  //   return `<button type="button" data-id="${item.category}" class="filter-btn">${item.category}</button>`
  // }))];
